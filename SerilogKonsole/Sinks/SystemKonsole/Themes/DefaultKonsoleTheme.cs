...
namespace SerilogKonsole.Sinks.SystemConsole.Themes
{
    ...
    /// </summary>
    public class DefaultKonsoleTheme : KonsoleTheme
    {
        /// <summary>
        /// A theme using only gray, black and white.
        /// </summary>
        public static DefaultKonsoleTheme Grayscale { get; } = DefaultKonsoleThemes.Grayscale;

        /// <summary>
        /// A theme in the style of the original <i>Serilog.Sinks.Literate</i>.
        /// </summary>
        public static DefaultKonsoleTheme Literate { get; } = DefaultKonsoleThemes.Literate;

        /// <summary>
        /// A theme based on the original Serilog "colored console" sink.
        /// </summary>
        public static DefaultKonsoleTheme Colored { get; } = DefaultKonsoleThemes.Colored;
        
        /// <summary>
        /// Construct a theme given a set of styles.
        /// </summary>
        /// <param name="styles">Styles to apply within the theme.</param>
        public DefaultKonsoleTheme(IReadOnlyDictionary<KonsoleThemeStyle, DefaultKonsoleThemeStyle> styles)
        {
        ...
        /// <inheritdoc/>
        public IReadOnlyDictionary<KonsoleThemeStyle, DefaultKonsoleThemeStyle> Styles { get; }
