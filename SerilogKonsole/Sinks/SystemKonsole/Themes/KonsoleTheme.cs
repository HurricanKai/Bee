...
namespace SerilogKonsole.Sinks.SystemConsole.Themes
{
    ...
    /// </summary>
    public abstract class KonsoleTheme
    {
        /// <summary>
        /// No styling applied.
        /// </summary>
        public static KonsoleTheme None { get; } = new EmptyKonsoleTheme();
        ...
        /// <summary>
        /// The number of characters written by the <see cref="Reset"/> method.
        /// </summary>
